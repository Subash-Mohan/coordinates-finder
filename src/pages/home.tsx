...
const Home = () => {
    ...
    const handleMouseMove = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
        ...
        setCoordinates({ x, y });
        setCoordinatesBy1({ x: parseFloat(normalizedXBy1), y: parseFloat(normalizedYBy1) });
        setCoordinatesBy10({ x: parseFloat(normalizedXBy10), y: parseFloat(normalizedYBy10) });
    };
  return (
    <div className=" h-full mx-auto bg-white">
        ...
        <main role="main" className="w-full sm:w-2/3 md:w-3/4 pt-1 px-2 bg-slate-200 flex justify-center items-center rounded-md shadow-lg">
            <div
                ...
                onMouseMove={handleMouseMove}>
                    <p className="text-center text-gray-500 mt-2">Move your cursor here</p>
            </div>
        </main>
    </div>
    </div>
